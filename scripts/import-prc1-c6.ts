...
async function importChapter6() {
  console.log('Starting PRC-1 Chapter 6 (Property, Plant and Equipment) Import...');
  const dataDir = path.join(__dirname, 'data');
  const files = ['prc1-c6-1.json', 'prc1-c6-2.json', 'prc1-c6-3.json', 'prc1-c6-4.json'];
  ...
  console.log(`\nDone! Seeded ${count}/${allQuestions.length} questions for PRC-1 Chapter 6.`);
}

importChapter6().catch(console.error);
