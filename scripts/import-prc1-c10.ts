...
async function importChapter10() {
  console.log('Starting PRC-1 Chapter 10 (Preparation of Financial Statements) Import...');
  const dataDir = path.join(__dirname, 'data');
  const files = ['prc1-c10-1.json', 'prc1-c10-2.json', 'prc1-c10-3.json', 'prc1-c10-4.json'];
  ...
  console.log(`\nDone! Seeded ${count}/${allQuestions.length} questions for PRC-1 Chapter 10.`);
}

importChapter10().catch(console.error);
