...
async function importChapter8() {
  console.log('Starting PRC-1 Chapter 8 (Correction of Errors) Import...');
  const dataDir = path.join(__dirname, 'data');
  const files = ['prc1-c8-1.json', 'prc1-c8-2.json', 'prc1-c8-3.json', 'prc1-c8-4.json'];
  ...
  console.log(`\nDone! Seeded ${count}/${allQuestions.length} questions for PRC-1 Chapter 8.`);
}

importChapter8().catch(console.error);
