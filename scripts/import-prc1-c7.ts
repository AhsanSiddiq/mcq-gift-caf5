...
async function importChapter7() {
  console.log('Starting PRC-1 Chapter 7 (IAS 2: Inventories) Import...');
  const dataDir = path.join(__dirname, 'data');
  const files = ['prc1-c7-1.json', 'prc1-c7-2.json', 'prc1-c7-3.json', 'prc1-c7-4.json'];
  ...
  console.log(`\nDone! Seeded ${count}/${allQuestions.length} questions for PRC-1 Chapter 7.`);
}

importChapter7().catch(console.error);
