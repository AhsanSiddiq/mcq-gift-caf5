...
async function importBatch4() {
    console.log('Starting PRC 2 Batch 4 import (6 parts, ~180 MCQs)...');
    ...
    for (const part of batchParts) {
        ...
        console.log(`Processing batch4-${part} (${mcqs.length} MCQs)...`);
        ...
        console.log(`  Finished batch4-${part}. Running total: ${totalImported}`);
    }

    console.log(`\n✅ Done! Successfully imported ${totalImported} MCQs for PRC 2 Batch 4.`);
}
